...
function () {
  ...
  _createClass(AuthenticationClient, [{
    ...
    value: function authenticate(authentication) {
      ...
      var promise = this.service.create(authentication).then(function (authResult) {
...
exports.defaultStorage = typeof window !== 'undefined' ? new storage_1.StorageWrapper(window.localStorage) : new storage_1.MemoryStorage();
exports.defaults = {
